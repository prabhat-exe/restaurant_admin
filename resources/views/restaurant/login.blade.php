                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center py-10">
                    <div class="relative hidden w-full items-center justify-center bg-brand-950 lg:flex dark:bg-gray-800 !W-100">
                        <div class="mx-auto max-w-sm px-8 text-center w-100 py-4">
                            <h2 class="text-2xl font-semibold text-white">Restaurant Admin Panel</h2>
                        </div>
                    </div>
                    <div class="mb-8">
                        <p class="text-sm text-gray-500 dark:text-gray-400">Enter your login credentials to continue.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('restaurant.login.submit') }}" id="loginForm" data-parsley-validate>
                        @csrf
                        <div class="space-y-5">
                            <div>
                    ...
                    <p class="mt-6 text-sm text-gray-500 dark:text-gray-400">To know your credentials, please contact the admin.</p>
                </div>
            </div>
        </div>
    </div>
