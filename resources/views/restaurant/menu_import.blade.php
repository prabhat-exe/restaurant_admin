            ...
            <form method="POST" action="{{ route('menu.import') }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <a href="{{ route('menu.sample.download') }}"
                        class="inline-flex items-center gap-2 rounded-lg border border-brand-500 px-4 py-2 text-sm font-medium text-brand-600 hover:bg-brand-50 dark:hover:bg-brand-500/10">
